...
ls /Volumes/
QT_QPA_PLATFORM=minimal sudo /Volumes/installer/installer.app --script tests/travis/osx/qt-installer-script.qs --addRepository https://install.skycoder42.de/qtmodules/mac_x64/
